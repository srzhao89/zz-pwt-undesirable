...
source("./Functions/coverage.ddf.illu.weighted.R")
...
for (i in 1:length(year)) {
  ...
  YDIREC=g
  #
  tt=coverage.ddf.illu.weighted(x=x,y=g,XDIREC=XDIREC,YDIREC=YDIREC,H2=H2,L=100)
  # 
...
tex = paste(tex,"\\\\")
write(tex,file="./Output/coverage-eff-without-CO2-weighted.tex")
