...
source("./Functions/coverage.ddf.illu.unweighted.R")
...
for (i in 1:length(year)) {
  ...
  YDIREC=g
  #
  tt=coverage.ddf.illu.unweighted(x=x,y=g,XDIREC=XDIREC,YDIREC=YDIREC,L=100)
  # 
...
tex = paste(tex,"\\\\")
write(tex,file="./Output/coverage-eff-without-CO2-unweighted.tex")
